...
class TypingCoursePage extends StatefulWidget {
  final dynamic courses;
  const TypingCoursePage({super.key, required this.courses});

  @override
  _TypingCoursePageState createState() => _TypingCoursePageState();
}

class _TypingCoursePageState extends State<TypingCoursePage> {
  dynamic dialogs;
